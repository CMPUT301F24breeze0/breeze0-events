...
public class OverallStorageControllerTest {
    ...
    public void testAddEntrant_Success() {
        Entrant entrant = new Entrant("testEntrantId", "Test User", "test@example.com", "1234567890", "photoUrl", "device1", new HashMap<>(), new HashMap<>(),new ArrayList<>(),new HashMap<>());
    ...
    public void testUpdateEntrant_Success() {
        Entrant entrant = new Entrant("testEntrantId", "Updated User", "updated@example.com", "0987654321", "newPhotoUrl", "device1", new HashMap<>(), new HashMap<>(),new ArrayList<>(),new HashMap<>());
