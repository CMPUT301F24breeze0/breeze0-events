...
public class US010602 {
    ...
    @Test
    public void testViewAndJoinEventByScanningQRCode() throws InterruptedException {
        ...
        // Confirm the event was joined successfully (can add additional checks here if needed)
    }
}
